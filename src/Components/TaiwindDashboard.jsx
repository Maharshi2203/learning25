  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        <div className="bg-white p-6 rounded border-xl border-gray-100 border-t-4 border-sky-500 min-h-400"></div>

        <div className="bg-white p-6 rounded border-xl border-gray-100 border-t-4 border-pink-500 min-h-400"></div>
      </div>
    </div>
  );
};
